...
smv_latex_friendly_map_plot = function(x) {
  ...
  x +
    ggplot2::scale_x_continuous(breaks = east_ticks, labels = east_labels, expand = c(0, 0)) +
    ggplot2::scale_y_continuous(breaks = north_ticks, labels = north_labels, expand = c(0, 0))
}
